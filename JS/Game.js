...
class Game {
    ...
    this.#ship.setPosition();
     ...
     this.#checkPositionInterval =setInterval(() => this.#checkPostion(), 1);
    }
    ...
    #randomNewEnemy(){
       ...
       randomNumber % 5 ? this.#createNewEnemy(this.#htmlElements.container,
        this.#enemiesInterval, "enemy", "explosion") : this.#createNewEnemy(this.#htmlElements.container,
            this.#enemiesInterval * 2, "enemy--big", "explosion--big",3)
    }
    ...
    #checkPostion(){
        ...
        this.#ship.missiles.forEach((missile, missileIndex, missleArr) => {
            ...
            if(missilePosition.bottom >= enemyPosition.top 
                ...
                && missilePosition.left <= enemyPosition.right) {
                    ...
                    if(!enemy.lives) {
                     ...
                     missile.remove();
                    missleArr.splice(missileIndex, 1);
                    this.#updateScore();
